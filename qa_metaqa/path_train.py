...
class PathTrain:
    def __init__(self):
        ...
        _, _, self.poss_path_embeds = read_obj(obj_name="ids, strings, and embeddings of possible shortest paths", file_path=args.out_path + args.qa_type + "/poss_paths.pickle")
        self.qid2embeds = read_obj(obj_name="train question embeddings", file_path=args.out_path + args.qa_type + "/train_qid2embeds.pickle")
        ...
        self.qid2path_dis = read_obj(obj_name="target train shortest path distances", file_path=args.out_path + args.qa_type + "/train_qid2path_dis.pickle")
        self.valid_qid2path_dis = read_obj(obj_name="target valid shortest path distances", file_path=args.out_path + args.qa_type + "/valid_qid2path_dis.pickle")
        self.test_qid2path_dis = read_obj(obj_name="target test shortest path distances", file_path=args.out_path + args.qa_type + "/test_qid2path_dis.pickle")
