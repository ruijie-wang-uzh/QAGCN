...
from models import PathAlign, PathAlign3
...
class PathTrain:
    def __init__(self):
        ...
        if args.qa_type == "2-hop":
            _, _, self.poss_path_embeds = read_obj(obj_name="ids, strings, and embeddings of possible shortest paths", file_path=os.path.join(args.out_path, "{}H-poss_paths.pickle".format(hop)))
    ...
    def eval(self, mode: str, model) -> float:
