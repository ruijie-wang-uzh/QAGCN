...
dataset = 'm'
hops = [1, 2, 3]
in_path = "../data/metaqa/input/X-hop/qa_Y.txt"
pre_data_path = "../data/metaqa/output/hop_prep_data.pickle"
model_path = "../data/metaqa/output/models/m_hop_prep.pt"
dict_path = "../data/metaqa/output/dict.pickle"
discard = 15
lr = 0.0005
batch_size = 16
num_epochs = 100
